...
------------------------------------------------------------
Responsible for: Centralizing all configuration for the RAG2 pipeline --
OpenAI model names, the Chroma persistence directory and collection name,
retrieval top-K, and debug/strict-output toggles -- loaded once from .env.
